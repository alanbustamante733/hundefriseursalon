...
public class DatenModifizieren extends javax.swing.JFrame {
    
    Controller control = null;
    int num_cliente;
    Haustier hausti;
    
    public DatenModifizieren(int num_cliente) {
        control = new Controller();
        initComponents();
        dateLaden(num_cliente);
    }
    ...
    private void initComponents() {
        ...
        jLabelDatenModifizieren = new javax.swing.JLabel();
        ...
        jLabelDatenModifizieren.setFont(new java.awt.Font("Dialog", 0, 48)); // NOI18N
        jLabelDatenModifizieren.setText("Daten modifizieren");
        ...
        jButton1.setText("zurück ohne speichern");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(btnSaubermachen, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(279, 279, 279)
                .addComponent(jLabelDatenModifizieren, javax.swing.GroupLayout.PREFERRED_SIZE, 420, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(36, 36, 36)
                .addComponent(jLabelDatenModifizieren)
    ...
    private void btnSpeichernActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSpeichernActionPerformed
        ...
        control.haustiermodifizieren(hausti, nameHaustier, rasse, farbe, allergien, besondernheiten, beobachtungen, nameBesitzer, handynummer);
        
        //Nachricht, dass alles ok ist.
        nachrichtAnzeigen("Bearbeitung ist erfolgreich abgeschlossen", "Info", "Bearbeitung");
    ...
    private javax.swing.JLabel jLabelDatenModifizieren;
    ...
    private void dateLaden(int num_cliente) {
        
        this.hausti = control.haustierHolen(num_cliente);
        
        txtName.setText(hausti.getName());
        txtRasse.setText(hausti.getRasse());
        txtFarbe.setText(hausti.getFarbe());
        txtBesitzerName.setText(hausti.getEinBesitzer().getName());
        txtHandynummer.setText(hausti.getEinBesitzer().getHandynummer());
        txtBeobachtungen.setText(hausti.getBeobachtungen());
        
        if (hausti.getAllergien().equals("ja")) {
            cmbAllergien.setSelectedIndex(1);
        }
        else {
            if(hausti.getAllergien().equals("nein")) {
                cmbAllergien.setSelectedIndex(2);
            }
            
        }
        
        if (hausti.getBesondernheiten().equals("ja")) {
            cmbBesonderheiten.setSelectedIndex(1);
        }
        else {
            if(hausti.getBesondernheiten().equals("nein")) {
                cmbBesonderheiten.setSelectedIndex(2);
            }
